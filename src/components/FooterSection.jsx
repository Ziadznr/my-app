...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden pt-0">
...
<div className="relative">
  ...
  >
    ...
    {/* 🔹 INSIDE STICKER (clipped) */}
    <div className="absolute top-0 right-0 translate-x-[40%] -translate-y-[40%] rotate-[18deg] z-20 pointer-events-none">
      <div className="w-[90px] h-[90px] rounded-full bg-pink-300 flex items-center justify-center font-bold">
        GH
      </div>
    </div>
        ...
        <div className="w-full max-w-[700px] px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-y-12 gap-x-24">
            ...
            <div className="md:col-span-4 flex flex-col gap-10 pt-60">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-3">
                  {[FaLinkedinIn, FaTwitter, FaInstagram, FaYoutube].map((Icon, i) => (
                    <div
                      key={i}
                      className="w-9 h-9 flex items-center justify-center rounded-full bg-white border border-black/10 hover:bg-black hover:text-white transition cursor-pointer"
                    >
                      <Icon size={14} />
                    </div>
                  ))}
              ...
              {/* BOTTOM */}
              <div className="pb-5  text-xs opacity-60 flex justify-between">
  ...
  <div className="absolute top-22 right-20 translate-x-[40%] -translate-y-[40%] rotate-[18deg] z-30">
    <div className="w-[90px] h-[90px] rounded-full bg-pink-300 flex items-center justify-center font-bold shadow-md">
      GH
    </div>
  </div>
